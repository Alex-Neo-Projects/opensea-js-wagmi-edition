...
const getPrivateListingConsiderations = (offer, privateSaleRecipient) => {
    return offer.map((item) => {
        return Object.assign(Object.assign({}, item), { recipient: privateSaleRecipient });
    });
};
...
const constructPrivateListingCounterOrder = (order, privateSaleRecipient) => {
    ...
    const counterOrder = {
        parameters: Object.assign(Object.assign({}, order.parameters), { offerer: privateSaleRecipient, offer: [
                {
