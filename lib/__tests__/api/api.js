...
(0, mocha_1.suite)("api", function () {
    ...
    (0, mocha_1.test)("Rinkeby API orders have correct OpenSea url", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, constants_2.rinkebyApi.getOrderLegacyWyvern({})];
                case 1:
                    order = _a.sent();
                    if (!order.asset) {
                        return [2 /*return*/];
                    }
                    url = "https://testnets.opensea.io/assets/rinkeby/".concat(order.asset.assetContract.address, "/").concat(order.asset.tokenId);
    ...
    (0, mocha_1.test)("Mainnet API orders have correct OpenSea url", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, constants_2.mainApi.getOrderLegacyWyvern({})];
                case 1:
                    order = _a.sent();
                    if (!order.asset) {
                        return [2 /*return*/];
                    }
                    url = "https://opensea.io/assets/ethereum/".concat(order.asset.assetContract.address, "/").concat(order.asset.tokenId);
                    chai_1.assert.equal(order.asset.openseaLink, url);
                    return [2 /*return*/];
            }
        });
    ...
    (0, mocha_1.test)("API fetches orderbook", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, constants_2.apiToTest.getOrdersLegacyWyvern()];
                case 1:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, constants_2.apiToTest.getOrdersLegacyWyvern()];
                case 1:
        ...
        (0, mocha_1.test)("API orderbook paginates", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), orders = _a.orders, count = _a.count;
                        return [4 /*yield*/, constants_2.apiToTest.getOrdersLegacyWyvern({}, 2)];
                    case 2:
                        pagination = _b.sent();
    ...
    (0, mocha_1.test)("API excludes cancelledOrFinalized and markedInvalid orders", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, constants_2.apiToTest.getOrdersLegacyWyvern({ limit: 50 })];
                case 1:
                    orders = (_a.sent()).orders;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    ...
                    return [3 /*break*/, 6];
                case 6: return [4 /*yield*/, constants_2.apiToTest.getOrdersLegacyWyvern({
                ...
                case 8:
                    ...
                    return [4 /*yield*/, constants_2.apiToTest.postOrderLegacyWyvern(newOrder)];
                case 9:
                    _a.sent();
                    return [3 /*break*/, 11];
                case 10:
