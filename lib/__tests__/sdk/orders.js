...
var manaAddress;
var daiAddress;
(0, mocha_1.suite)("SDK: orders", function () {
    ...
    (0, mocha_1.test)("Correctly errors for invalid buy order price parameters", function () { return __awaiter(void 0, void 0, void 0, function () {
        var accountAddress, currentSeconds, expirationTime, tokenId, tokenAddress, error_9;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    accountAddress = constants_2.ALEX_ADDRESS_2;
                    currentSeconds = Math.round(Date.now() / 1000);
                    expirationTime = currentSeconds + 20 * 60;
                    tokenId = constants_2.MYTHEREUM_TOKEN_ID.toString();
                    tokenAddress = constants_2.MYTHEREUM_ADDRESS;
                    _a.label = 1;
                case 1:
    ...
    (0, mocha_1.test)("Cannot yet match a new English auction sell order, bountied", function () { return __awaiter(void 0, void 0, void 0, function () {
        var accountAddress, takerAddress, amountInToken, paymentTokenAddress, currentSeconds, expirationTime, bountyPercent, tokenId, tokenAddress, _asset, order, error_10;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    accountAddress = constants_2.ALEX_ADDRESS;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    paymentTokenAddress = constants_2.WETH_ADDRESS;
                    return [4 /*yield*/, rinkebyClient.api.getOrdersLegacyWyvern({
                ...
                case 1:
                    ...
                    return [4 /*yield*/, rinkebyClient.getCurrentPriceLegacyWyvern(sell)];
                case 2:
                    sellPrice = _a.sent();
                    return [4 /*yield*/, rinkebyClient.getCurrentPriceLegacyWyvern(buy)];
                case 3:
                    buyPrice = _a.sent();
    ...
    (0, mocha_1.test)("Serializes payment token and matches most recent ERC-20 sell order", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    takerAddress = constants_2.ALEX_ADDRESS;
                    return [4 /*yield*/, client.api.getOrderLegacyWyvern({
    ...
    mocha_1.test.skip("orderToJSON computes correct current price for Dutch auctions", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, client.api.getOrdersLegacyWyvern({
    ...
    mocha_1.test.skip("orderToJSON current price does not include buyer fee for English auctions", function () { return __awaiter(void 0, void 0, void 0, function () {
        var orders;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, client.api.getOrdersLegacyWyvern({
    ...
    mocha_1.test.skip("Matches first buy order in book", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, client.api.getOrderLegacyWyvern({
                        side: types_2.OrderSide.Buy,
                    })];
                case 1:
                    order = _a.sent();
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    isValid = _b.sent();
                    chai_1.assert.isTrue(isValid);
                    return [4 /*yield*/, client.isOrderFulfillableLegacyWyvern({
                            order: order,
                            accountAddress: accountAddress,
                            recipientAddress: recipientAddress,
