...
var OpenSeaSDK = /** @class */ (function () {
    ...
    OpenSeaSDK.prototype.fulfillOrder = function (_b) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var isPrivateListing, transactionHash, _c, executeAllActions, transaction, e_1;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                    ...
                    case 1:
                        _d.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, this.seaport.fulfillOrder({
                    ...
                    case 4:
                        e_1 = _d.sent();
                        this._dispatch(types_1.EventType.TransactionFailedBeforeSending, { "error": e_1.reason });
                        return [2 /*return*/, 'Transaction failed before sending'];
                    case 5: return [3 /*break*/, 7];
                    case 6: throw new Error("Unsupported protocol");
                    case 7: return [4 /*yield*/, this._confirmTransaction(transactionHash, types_1.EventType.MatchOrders, "Fulfilling order")];
                    case 8:
                        _d.sent();
                        return [2 /*return*/, transactionHash];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3: return [2 /*return*/, _b.sent()];
                    case 4:
                        this.addListener(types_1.EventType.TransactionCreated, function (_b) {
                            var transactionHash = _b.transactionHash;
                            return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_c) {
                                    console.log("[sdk.ts] buyNFT(): Listener responded with transaction sent.");
